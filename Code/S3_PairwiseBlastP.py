...
parser.add_argument('-i', '--in_fol', default = '../data/primTran', help = 'folder that has original cds or petide fasta file')
...
parser.add_argument('-o', '--out_fol', default = '../data/blastp', help = 'folder that has original cds or petide fasta file')
...
parser.add_argument('-d', '--doc_fol', default = '../doc/blastp', help = 'folder that will have the job submission files')
