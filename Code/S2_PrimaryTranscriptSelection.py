...
parser.add_argument('-C', '--in_cds_dir', default = '../data/cds', help = 'folder that has original cds or petide fasta file')
parser.add_argument('-F', '--cds_suf', default = 'fa')
parser.add_argument('-B', '--biotype', default = 'biotype=protein_coding')
parser.add_argument('-I', '--in_gff_dir', default = '../data/gff', help = 'folder that has original gff file')
...
parser.add_argument('-g', '--gff_out_dir', default = '../data/edited_gff', help = 'folder that will have edited gff files')
parser.add_argument('-f', '--fasta_out_dir', default = '../data/primTran', help = 'folder that will fasta files')
...
"""Iterate over the species list or run for the species"""
